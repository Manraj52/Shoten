...
func newAnimator(container *element, sequences map[string]*sequence,
...
func (an *animator) onDraw(renderer *sdl.Renderer) error {
	...
	return drawTexture(tex, an.container.position, an.container.rotation,
		renderer)
}
func (an *animator) onCollision(other *element) error {return nil}
...
func newSequence(filepath string, sampleRate float64, loop bool,
